        ...
        {filteredTyres.length === 0 ? (
          ...
          filteredTyres.map((tyre, idx) => (
            <motion.article
              ...
              aria-label={`${tyre.brand} ${tyre.model} tyre, size ${tyre.size}, type ${tyre.type}, priced £${tyre.price}`}
            >
              <motion.img
                src={tyre.img}
              ...
              <div style={{ color: "#b4081b", fontWeight: 800 }}>£{tyre.price}</div>
              <button
                type="button"
              ...
              <button
                ...
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  if (typeof onSetReminder === "function") onSetReminder(tyre);
                }}
